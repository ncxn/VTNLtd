...
class User extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->hasOne('id', 'Vtnltd\Model\User\UserProfile', 'user_id', array(
            'alias' => 'profile',
            'reusable' => true,
            'foreignKey' => array(
        ...
        $this->hasMany('id', 'Vtnltd\Model\User\UserSuccessLogins', 'user_id', array(
            'alias' => 'successLogins',
            'foreignKey' => array(
                'action' => \Phalcon\Mvc\Model\Relation::ACTION_CASCADE,
            ),
        ...
        $this->belongsTo('group_id', 'Vtnltd\Model\User\UserGroups', 'id', array(
            'alias' => 'group',
            'reusable' => true,
        ));

        $this->hasMany('id', 'Vtnltd\Model\User\UserPasswordChanges', 'user_id', array(
        ...
        $this->hasMany('id', 'Vtnltd\Model\User\UserResetPasswords', 'user_id', array(
