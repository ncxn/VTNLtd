...
class User extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->hasOne('id', 'Vtnltd\Models\User\UserProfile', 'user_id', array(
            'alias' => 'profile',
            'reusable' => true,
            'foreignKey' => array(
        ...
        $this->hasMany('id', 'Vtnltd\Models\User\UserSuccessLogins', 'user_id', array(
            'alias' => 'successLogins',
            'foreignKey' => array(
                'action' => \Phalcon\Mvc\Model\Relation::ACTION_CASCADE,
            ),
        ...
        $this->belongsTo('group_id', 'Vtnltd\Models\User\UserGroups', 'id', array(
            'alias' => 'group',
            'reusable' => true,
        ));

        $this->hasMany('id', 'Vtnltd\Models\User\UserPasswordChanges', 'user_id', array(
        ...
        $this->hasMany('id', 'Vtnltd\Models\User\UserResetPasswords', 'user_id', array(
