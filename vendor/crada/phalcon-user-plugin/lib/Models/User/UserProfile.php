...
class UserProfile extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->belongsTo('user_id', 'Vtnltd\Models\User\User', 'id', array(
            'alias' => 'user',
            'reusable' => true,
        ));

        $this->belongsTo('home_location_id', 'Vtnltd\Models\Location\Locations', 'id', array(
            'alias' => 'homeLocation',
            'reusable' => true,
        ));

        $this->belongsTo('current_location_id', 'Vtnltd\Models\Location\Locations', 'id', array(
