...
class SecurityTest extends \UnitTestCase
{
    ...
    public function testBeforeDispatchLoopRedirect()
    {
        ...
        $auth = $this->getMockBuilder('Vtnltd\Auth\Auth')
        ...
        $security = new Vtnltd\Plugin\Security();
     ...
     * @expectedException           Vtnltd\Exception\UserPluginException
     ...
     * @group getConfigureStructure
     *
     * @throws \Vtnltd\Exception\UserPluginException
     */
